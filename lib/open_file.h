...
public:
  OpenFileAdapter(Source source) : source_(source) {}
...
template <typename Source>
auto operator|(Source source, OpenFilePart open_file_part) {
  return OpenFileAdapter<Source>(source);
}